...
node* loop1(ifstream& inFile) {
	if(pToken.ID_tk == Repeat_tk) {
		...
		cout << "Parser.cpp: Wrong token... wanting Repeat Keyword but received " << tokenNames[pToken.ID_tk] << " on line " << depth << "\n";
        exit(1);
	}
}
...
node* loop2(ifstream& inFile) {
	...
	if(pToken.ID_tk == Repeat_tk) {
		...
		if(pToken.ID_tk == Until_tk){
            ...
            cout << "Parser.cpp: Wrong token... wanting Until Keyword but received " << tokenNames[pToken.ID_tk] << " on line " << depth << "\n";
            exit(1);
        }
	} else {
		cout << "Parser.cpp: Wrong token... wanting Repeat Keyword but received " << tokenNames[pToken.ID_tk] << " on line " << depth << "\n";
	...
	if(pToken.ID_tk == Assign_tk) {
		...
		if(pToken.ID_tk == IDENT_tk) {
			...
			if(pToken.ID_tk == Equals_tk) {
				...
				cout << "Parser.cpp: Wrong token... wanting Equals but received " << tokenNames[pToken.ID_tk] << " on line " << depth << "\n";
                exit(1);
			}
		} else {
			cout << "Parser.cpp: Wrong token... wanting Identifier but received " << tokenNames[pToken.ID_tk] << " on line " << depth << "\n";
		...
		cout << "Parser.cpp: Wrong token... wanting Assign Keyword but received " << tokenNames[pToken.ID_tk] << " on line " << depth << "\n";
        exit(1);
	}
}
	...
	if(pToken.ID_tk == Greater_equal_tk) {
		...
		if(pToken.ID_tk == Dot_tk) {
			...
			if(pToken.ID_tk == Dot_tk) {
				...
				cout << "Parser.cpp: Wrong token... on line " << depth << "... wanting '.'\n";
        	    exit(1);
			}
		} else {
			cout << "Parser.cpp: Wrong token... on line " << depth << "... wanting '.'\n";
		...
		cout << "Parser.cpp: Wrong token... wanting <= , >= , == , ... , or != but received " << tokenNames[pToken.ID_tk] << " on line " << depth << "\n";
		exit(1);
	}
}
...
node* label(ifstream& inFile) {
	...
	if(pToken.ID_tk == Label_tk) {
		...
		cout << "Parser.cpp: Wrong token... wanting Label Keyword but received " << tokenNames[pToken.ID_tk] << " on line " << depth << "\n";
        exit(1);
	}
}
...
node* goto_F(ifstream& inFile) {
	if(pToken.ID_tk == Portal_tk) {
        ...
        if(pToken.ID_tk == IDENT_tk) {
            ...
            cout << "Parser.cpp: Wrong token... wanting Portal Keyword but recieved " << tokenNames[pToken.ID_tk] << " on line " << depth << "\n";
            exit(1);
        }
}